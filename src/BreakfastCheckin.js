...
const BreakfastCheckin = () => {
    ...
    const handleRefresh = async () => {
        if (window.confirm("データをリフレッシュしますか？")) {
            try {
    ...
    return (
        <div className="checkin-container">
            ...
            <div className="input-and-purchase">
                <div className="input-section" style={{ maxWidth: '600px', width: '100%' }}>
                    <h3>朝食リストアップロード</h3>
                    <input type="file" accept=".xlsx, .xls" onChange={(e) => readExcelFile(e.target.files[0])} />
                    <button onClick={handleRefresh}>Refresh</button>
                </div>
                <div className="purchase-section" style={{ maxWidth: '600px', width: '100%' }}>
                    <h3>当日朝食購入</h3>
